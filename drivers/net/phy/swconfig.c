...
swconfig_find_dev(struct genl_info *info)
{
	...
	/* http://crbug.com/634957
	 * The code was changed to avoid the symptom and now has a race.
	 * If "dev" goes away after the lock is released, the caller of this
	 * function will be left with a stale reference. mutex_lock() will
	 * page fault.
	 */
	return dev;
}
